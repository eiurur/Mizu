...
module.exports = class Scraper {
  ...
  download(params) {
    return new Promise( resolve => {
      return ImageDownloader.download(params)
  ...
  downloadIllusts() {
    return new Promise((resolve, reject) => {
      ...
      .then( downloadResultList => resolve(this.filterNormalIllust(downloadResultList)) )
  ...
  filterNormalIllust(downloadedIllustList) {
    return this._illustList.filter( illust => downloadedIllustList.includes(illust.filename));
  }
