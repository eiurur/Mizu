...
const AmatsukaRequester = require('./requesters/AmatsukaRequester');
...
module.exports = class Mizu {
  ...
  static createCrawler(params) {
    switch (params.name.toLowerCase()) {
      case 'amatsuka':
        return new AmatsukaRequester(params);
      case 'danbooru':
        return new DanbooruScraper(params);
      case 'sankaku_complex':
        return new SankakuComplexRequester(params);
      case 'yande_re':
        return new YandereScraper(params);
      default:
        return null;
    }
  }
