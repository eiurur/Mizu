...
//     };
//     const sankaku_complex = Mizu.createCrawler(opts);
//     assert(sankaku_complex.next(1, 'day').date ===
//         moment()
//           .add(1, 'days')
//           .format('YYYY-MM-DD'));
//     assert(sankaku_complex.next(1, 'week').date ===
//         moment()
//           .add(1, 'days')
//           .add(1, 'weeks')
//           .format('YYYY-MM-DD'));
//     assert(sankaku_complex.next(1, 'month').date ===
//         moment()
//           .add(1, 'days')
//           .add(1, 'weeks')
//           .add(1, 'months')
...
//     };
//     const sankaku_complex = Mizu.createCrawler(opts);
//     assert(sankaku_complex.prev(2, 'day').date ===
//         moment()
//           .subtract(2, 'days')
//           .format('YYYY-MM-DD'));
//     assert(sankaku_complex.prev(2, 'week').date ===
//         moment()
//           .subtract(2, 'days')
//           .subtract(2, 'weeks')
//           .format('YYYY-MM-DD'));
//     assert(sankaku_complex.prev(2, 'month').date ===
//         moment()
//           .subtract(2, 'days')
//           .subtract(2, 'weeks')
//           .subtract(2, 'months')
